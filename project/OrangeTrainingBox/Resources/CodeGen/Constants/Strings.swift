...
internal enum L10n {
  ...
  internal enum Settings {
    internal enum About {
      ...
      internal static let copyright = L10n.tr("Localizable", "Settings.About.Copyright")
      /// Legal Notices
      internal static let legalNotices = L10n.tr("Localizable", "Settings.About.LegalNotices")
      /// Terms of Use
      internal static let termsOfUse = L10n.tr("Localizable", "Settings.About.TermsOfUse")
      /// About
