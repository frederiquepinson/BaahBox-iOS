...
internal enum StoryboardScene {
  ...
  internal enum Settings: StoryboardType {
    ...
    internal static let aboutViewController = SceneType<OrangeTrainingBox.AboutViewController>(storyboard: Settings.self, identifier: "AboutViewController")

    internal static let genericWebViewController = SceneType<OrangeTrainingBox.GenericWebViewController>(storyboard: Settings.self, identifier: "GenericWebViewController")
